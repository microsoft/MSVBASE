#ifndef PASE_HNSWINDEX_BUILDER_HPP
#define PASE_HNSWINDEX_BUILDER_HPP
...
public:
     ...
     */
   PASE_HNSWIndexBuilder(Relation m_heap, Relation m_index, IndexInfo *m_indexInfo);
...
private:
    ...
    friend void PASE_HNSWLoadTupleCallback(Relation index,
                                  ItemPointer tid,
                                  Datum *values,
                                  bool *isnull,
                                  bool tupleIsAlive,
    ...
    friend void PASE_HNSWComputeElementsCallback(Relation index,
                                      ItemPointer tid,
                                      Datum *values,
                                      bool *isnull,
                                      bool tupleIsAlive,
